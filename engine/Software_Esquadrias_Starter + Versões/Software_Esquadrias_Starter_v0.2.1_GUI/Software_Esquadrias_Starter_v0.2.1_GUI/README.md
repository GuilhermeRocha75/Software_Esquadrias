# Software Esquadrias — CR Engine + Tester v0.2.1

## Correções deste ciclo

- comparação com Excel agora usa **TOTAL DO PEDIDO**, não custo unitário;
- nomenclatura da BOM ficou explícita: preço-base, custo na esquadria e custo total do pedido;
- novo botão **Exportar BOM CSV (comparar com Excel)**;
- documentação de diagnóstico dos preços de perfis;
- arquitetura Web/SaaS multiempresa documentada;
- novo schema PostgreSQL `schema_v0_2_saas.sql` com usuário global + memberships por empresa + PLATFORM_ADMIN.
