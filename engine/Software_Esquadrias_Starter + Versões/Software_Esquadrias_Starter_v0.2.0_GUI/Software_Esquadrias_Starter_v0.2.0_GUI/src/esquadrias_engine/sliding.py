...
from .models import (
    LeafSystem, SlidingConfiguration, CalculationResult, BomComponent, EngineeringWarning
)
from .catalog import (
...
def _add_finish(bom: list[BomComponent], cfg: SlidingConfiguration,
    ...
    if code is None:
        return
    # CR!G49/G51: porta usa 1 peça na largura; janela usa 2.
    width_qty = 1.0 if cfg.leaf_system != LeafSystem.PRIME_WINDOW_42x66 else 2.0
