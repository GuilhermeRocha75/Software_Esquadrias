...
class GrEndpointTests(unittest.TestCase):
    def test_health_exposes_v015(self):
        response = health()
        self.assertEqual(response["engine"], "CR_ENGINE_0.5.0")
        self.assertEqual(response["engines"], ["CR_ENGINE_0.5.0", "MX_ENGINE_0.3.0", "GR_ENGINE_0.15.0"])

    def test_options_expose_phase15_and_top_flag_scope(self):
        response = gr_options()
        self.assertEqual(response["engine_version"], "GR_ENGINE_0.15.0")
        self.assertEqual(response["phase"], 15)
        ...
        self.assertEqual(response["technical_gate"]["status"], "APROVADO_NO_ESCOPO_DA_FASE_15")
        ...
        self.assertEqual(response["fixed_panels"]["leaf_count"], 1)
        ...
        self.assertEqual(response["fixed_panels"]["historical_reference_orcs_rows"], [14891, 11251])
